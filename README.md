...
This is an MCP (Model Context Protocol) server that provides access to the New Test API API. It enables AI agents and LLMs to interact with New Test API through standardized tools.

## Features

- 🔧 **MCP Protocol**: Built on the Model Context Protocol for seamless AI integration
- 🌐 **Full API Access**: Provides tools for interacting with New Test API endpoints
- 🐳 **Docker Support**: Easy deployment with Docker and Docker Compose
- ⚡ **Async Operations**: Built with FastMCP for efficient async handling

## API Documentation

- **New Test API Website**: [https://api.apis.guru/v2/](https://api.apis.guru/v2/)
- **API Documentation**: []()
...
*Note: Replace `example_tool` with actual New Test API API tools based on the documentation.*
...
1. Clone this repository:
   ```bash
   git clone https://github.com/Traia-IO/new-test-api-mcp-server.git
   cd new-test-api-mcp-server
   ```
...
1. Create API client functions for New Test API endpoints
...
```json
{
  "github_url": "https://github.com/Traia-IO/new-test-api-mcp-server",
  "mcp_server": {
    "name": "new-test-api-mcp",
